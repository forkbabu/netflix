...
# static fields
.field static final G0:Ljava/lang/String; = "MediaRouteCastDialog"

.field static final H0:I

.field private static final I0:J = 0x12cL

.field static final J0:I = 0x1


# instance fields
.field A0:Landroidx/mediarouter/app/a$d;

.field B0:Landroid/graphics/Bitmap;

.field C0:Landroid/net/Uri;

.field D0:Z

.field E0:Landroid/graphics/Bitmap;

.field F0:I

.field final c:Lc/s/b/k;

.field private final d:Landroidx/mediarouter/app/a$f;

.field private e:Lc/s/b/j;

.field final f:Lc/s/b/k$g;
...
.field o0:Landroidx/mediarouter/app/a$h;
...
.field x0:Landroid/support/v4/media/session/MediaControllerCompat;

.field y0:Landroidx/mediarouter/app/a$e;

.field z0:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method static constructor <clinit>()V
    ...
    sput v1, Landroidx/mediarouter/app/a;->H0:I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->e:Lc/s/b/j;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->c:Lc/s/b/k;
    ...
    iget-object p1, p0, Landroidx/mediarouter/app/a;->c:Lc/s/b/k;

    invoke-virtual {p1}, Lc/s/b/k;->f()Lc/s/b/k$g;

    move-result-object p1

    iput-object p1, p0, Landroidx/mediarouter/app/a;->f:Lc/s/b/k$g;
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->y0:Landroidx/mediarouter/app/a$e;

    iget-object p1, p0, Landroidx/mediarouter/app/a;->c:Lc/s/b/k;

    invoke-virtual {p1}, Lc/s/b/k;->c()Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method private a(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->x0:Landroid/support/v4/media/session/MediaControllerCompat;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/mediarouter/app/a;->y0:Landroidx/mediarouter/app/a$e;
    ...
    iput-object v1, p0, Landroidx/mediarouter/app/a;->x0:Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/a;->x0:Landroid/support/v4/media/session/MediaControllerCompat;
    :try_end_0
    ...
    :goto_0
    iget-object p1, p0, Landroidx/mediarouter/app/a;->x0:Landroid/support/v4/media/session/MediaControllerCompat;

    if-eqz p1, :cond_3

    iget-object v0, p0, Landroidx/mediarouter/app/a;->y0:Landroidx/mediarouter/app/a$e;
    ...
    :goto_2
    iput-object v1, p0, Landroidx/mediarouter/app/a;->z0:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method private j()Z
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->z0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :goto_0
    iget-object v2, p0, Landroidx/mediarouter/app/a;->z0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :goto_1
    iget-object v2, p0, Landroidx/mediarouter/app/a;->A0:Landroidx/mediarouter/app/a$d;

    if-nez v2, :cond_2

    iget-object v2, p0, Landroidx/mediarouter/app/a;->B0:Landroid/graphics/Bitmap;
    ...
    :goto_2
    iget-object v3, p0, Landroidx/mediarouter/app/a;->A0:Landroidx/mediarouter/app/a$d;

    if-nez v3, :cond_3

    iget-object v3, p0, Landroidx/mediarouter/app/a;->C0:Landroid/net/Uri;
    ...
    invoke-static {v3, v1}, Lc/i/n/e;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private k()V
    ...
    iget-object v3, p0, Landroidx/mediarouter/app/a;->z0:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :cond_1
    invoke-virtual {v3}, Landroid/support/v4/media/MediaDescriptionCompat;->h()Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/a;->u0:Landroid/widget/TextView;
    ...
    :cond_2
    iget-object v0, p0, Landroidx/mediarouter/app/a;->u0:Landroid/widget/TextView;

    iget-object v2, p0, Landroidx/mediarouter/app/a;->w0:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->v0:Landroid/widget/TextView;
...
.method a(II)I
    ...
    iget-object p1, p0, Landroidx/mediarouter/app/a;->t0:Landroid/widget/ImageView;
...
.method public a(Lc/s/b/j;)V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->e:Lc/s/b/j;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->c:Lc/s/b/k;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lc/s/b/k;->a(Lc/s/b/j;Lc/s/b/k$a;I)V
...
.method public a(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/mediarouter/app/a;->a(Lc/s/b/k$g;)Z
...
.method public a(Lc/s/b/k$g;)Z
    ...
    invoke-virtual {p1}, Lc/s/b/k$g;->x()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p1}, Lc/s/b/k$g;->z()Z
...
.method b(Ljava/util/List;)V
    ...
    invoke-virtual {p1}, Landroidx/mediarouter/app/a$g;->b()V
...
.method c()V
    ...
    iput-boolean v0, p0, Landroidx/mediarouter/app/a;->D0:Z

    const/4 v1, 0x0

    iput-object v1, p0, Landroidx/mediarouter/app/a;->E0:Landroid/graphics/Bitmap;

    iput v0, p0, Landroidx/mediarouter/app/a;->F0:I
...
.method public f()V
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/a;->c:Lc/s/b/k;

    invoke-virtual {v1}, Lc/s/b/k;->e()Ljava/util/List;
...
.method g()V
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->f:Lc/s/b/k$g;

    invoke-virtual {v0}, Lc/s/b/k$g;->B()Z
    ...
    invoke-virtual {v0}, Lc/s/b/k$g;->x()Z
    ...
    :cond_1
    iget-boolean v0, p0, Landroidx/mediarouter/app/a;->D0:Z

    const/16 v1, 0x8

    if-eqz v0, :cond_3

    iget-object v0, p0, Landroidx/mediarouter/app/a;->E0:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Landroidx/mediarouter/app/a;->t0:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Landroidx/mediarouter/app/a;->E0:Landroid/graphics/Bitmap;
    ...
    iget v1, p0, Landroidx/mediarouter/app/a;->F0:I

    invoke-virtual {v0, v1}, Landroid/widget/ImageView;->setBackgroundColor(I)V

    iget-object v0, p0, Landroidx/mediarouter/app/a;->s0:Landroid/widget/RelativeLayout;

    new-instance v1, Landroid/graphics/drawable/BitmapDrawable;

    iget-object v2, p0, Landroidx/mediarouter/app/a;->E0:Landroid/graphics/Bitmap;
...
.method h()V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/mediarouter/app/a;->A0:Landroidx/mediarouter/app/a$d;
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/a;->A0:Landroidx/mediarouter/app/a$d;
...
.method i()V
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/a;->B0:Landroid/graphics/Bitmap;

    iput-object v0, p0, Landroidx/mediarouter/app/a;->C0:Landroid/net/Uri;
...
.method public onAttachedToWindow()V
    ...
    iget-object v2, p0, Landroidx/mediarouter/app/a;->e:Lc/s/b/j;

    iget-object v3, p0, Landroidx/mediarouter/app/a;->d:Landroidx/mediarouter/app/a$f;

    invoke-virtual {v1, v2, v3, v0}, Lc/s/b/k;->a(Lc/s/b/j;Lc/s/b/k$a;I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    sget p1, Lc/s/a$j;->mr_cast_dialog:I

    invoke-virtual {p0, p1}, Landroidx/appcompat/app/g;->setContentView(I)V

    sget p1, Lc/s/a$g;->mr_cast_close_button:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->q0:Landroid/widget/ImageButton;
    ...
    sget p1, Lc/s/a$g;->mr_cast_stop_button:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->r0:Landroid/widget/Button;
    ...
    sget p1, Lc/s/a$g;->mr_cast_list:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->o0:Landroidx/mediarouter/app/a$h;
    ...
    iput p1, p0, Landroidx/mediarouter/app/a;->p0:I

    sget p1, Lc/s/a$g;->mr_cast_meta:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->s0:Landroid/widget/RelativeLayout;

    sget p1, Lc/s/a$g;->mr_cast_meta_art:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->t0:Landroid/widget/ImageView;

    sget p1, Lc/s/a$g;->mr_cast_meta_title:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->u0:Landroid/widget/TextView;

    sget p1, Lc/s/a$g;->mr_cast_meta_subtitle:I
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/a;->v0:Landroid/widget/TextView;
    ...
    sget v0, Lc/s/a$k;->mr_cast_dialog_title_view_placeholder:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Landroidx/mediarouter/app/a;->w0:Ljava/lang/String;
