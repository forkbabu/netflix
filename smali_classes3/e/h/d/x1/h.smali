...
.method public static declared-synchronized a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_2
    invoke-static {p0}, Le/h/d/x1/h;->a(Ljava/lang/String;)Ljavax/crypto/spec/SecretKeySpec;
    ...
    sget-boolean p0, Le/h/d/x1/h;->a:Z

    if-nez p0, :cond_2

    const/4 p0, 0x1

    sput-boolean p0, Le/h/d/x1/h;->a:Z
    ...
    :goto_0
    new-instance p0, Le/h/c/b;

    const/16 v1, 0x72

    invoke-direct {p0, v1, p1}, Le/h/c/b;-><init>(ILorg/json/JSONObject;)V

    invoke-static {}, Le/h/d/n1/g;->g()Le/h/d/n1/g;

    move-result-object p1

    invoke-virtual {p1, p0}, Le/h/d/n1/b;->a(Le/h/c/b;)V
