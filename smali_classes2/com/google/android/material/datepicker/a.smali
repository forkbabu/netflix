...
.field private final f:Le/f/b/b/r/o;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILe/f/b/b/r/o;Landroid/graphics/Rect;)V
    .locals 1
    ...
    invoke-static {v0}, Lc/i/n/i;->a(I)I
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/a;->f:Le/f/b/b/r/o;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/a;
    ...
    invoke-static {v1, v2}, Lc/i/n/i;->a(ZLjava/lang/Object;)V

    sget-object v1, Le/f/b/b/a$o;->MaterialCalendarItem:[I

    invoke-virtual {p0, p1, v1}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_android_insetLeft:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v1

    sget v2, Le/f/b/b/a$o;->MaterialCalendarItem_android_insetTop:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v2

    sget v3, Le/f/b/b/a$o;->MaterialCalendarItem_android_insetRight:I

    invoke-virtual {p1, v3, v0}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result v3

    sget v4, Le/f/b/b/a$o;->MaterialCalendarItem_android_insetBottom:I
    ...
    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_itemFillColor:I

    invoke-static {p0, p1, v1}, Le/f/b/b/o/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_itemTextColor:I

    invoke-static {p0, p1, v1}, Le/f/b/b/o/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v7

    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_itemStrokeColor:I

    invoke-static {p0, p1, v1}, Le/f/b/b/o/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v8

    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_itemStrokeWidth:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v9

    sget v1, Le/f/b/b/a$o;->MaterialCalendarItem_itemShapeAppearance:I

    invoke-virtual {p1, v1, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v1

    sget v2, Le/f/b/b/a$o;->MaterialCalendarItem_itemShapeAppearanceOverlay:I

    invoke-virtual {p1, v2, v0}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v0

    invoke-static {p0, v1, v0}, Le/f/b/b/r/o;->a(Landroid/content/Context;II)Le/f/b/b/r/o$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILe/f/b/b/r/o;Landroid/graphics/Rect;)V
...
.method a(Landroid/widget/TextView;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Le/f/b/b/r/o;

    invoke-virtual {v0, v2}, Le/f/b/b/r/j;->setShapeAppearanceModel(Le/f/b/b/r/o;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->f:Le/f/b/b/r/o;

    invoke-virtual {v1, v2}, Le/f/b/b/r/j;->setShapeAppearanceModel(Le/f/b/b/r/o;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/a;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Le/f/b/b/r/j;->a(Landroid/content/res/ColorStateList;)V
