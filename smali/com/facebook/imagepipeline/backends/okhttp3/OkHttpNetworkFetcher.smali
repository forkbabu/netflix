...
# instance fields
.field private final mCallFactory:Lo/e$a;
...
.method public constructor <init>(Lo/b0;)V
    ...
    invoke-virtual {v0}, Lo/p;->b()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;-><init>(Lo/e$a;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method public constructor <init>(Lo/e$a;Ljava/util/concurrent/Executor;)V
    .locals 0

    invoke-direct {p0}, Lcom/facebook/imagepipeline/producers/BaseNetworkFetcher;-><init>()V

    iput-object p1, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCallFactory:Lo/e$a;
...
.method static synthetic access$100(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;Lo/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->handleException(Lo/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V

    return-void
.end method

.method private handleException(Lo/e;Ljava/lang/Exception;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    .locals 0

    invoke-interface {p1}, Lo/e;->s()Z
...
.method public fetch(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    ...
    invoke-direct {v2}, Lo/d$a;-><init>()V

    invoke-virtual {v2}, Lo/d$a;->d()Lo/d$a;
    ...
    invoke-virtual {v1, v2}, Lo/f0$a;->a(Lo/d;)Lo/f0$a;
    ...
    invoke-virtual {v0}, Lo/f0$a;->c()Lo/f0$a;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->fetchWithRequest(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;Lo/f0;)V
    :try_end_0
...
.method protected fetchWithRequest(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;Lo/f0;)V
    .locals 2

    iget-object v0, p0, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;->mCallFactory:Lo/e$a;

    invoke-interface {v0, p3}, Lo/e$a;->a(Lo/f0;)Lo/e;
    ...
    invoke-direct {v1, p0, p3}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$1;-><init>(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;Lo/e;)V
