...
.field private final mOkHttpClient:Lo/b0;
...
.method public constructor <init>(Lo/b0;)V
    ...
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher;-><init>(Lo/b0;)V

    iput-object p1, p0, Lcom/facebook/react/modules/fresco/ReactOkHttpNetworkFetcher;->mOkHttpClient:Lo/b0;

    invoke-virtual {p1}, Lo/b0;->j()Lo/p;

    move-result-object p1

    invoke-virtual {p1}, Lo/p;->b()Ljava/util/concurrent/ExecutorService;
...
.method public fetch(Lcom/facebook/imagepipeline/backends/okhttp3/OkHttpNetworkFetcher$OkHttpNetworkFetchState;Lcom/facebook/imagepipeline/producers/NetworkFetcher$Callback;)V
    ...
    invoke-direct {v3}, Lo/d$a;-><init>()V

    invoke-virtual {v3}, Lo/d$a;->d()Lo/d$a;

    move-result-object v3

    invoke-virtual {v3}, Lo/d$a;->a()Lo/d;

    move-result-object v3

    invoke-virtual {v2, v3}, Lo/f0$a;->a(Lo/d;)Lo/f0$a;
    ...
    invoke-virtual {v2, v0}, Lo/f0$a;->b(Ljava/lang/String;)Lo/f0$a;

    move-result-object v0

    invoke-static {v1}, Lo/u;->a(Ljava/util/Map;)Lo/u;
