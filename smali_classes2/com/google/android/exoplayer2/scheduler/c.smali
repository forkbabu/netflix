...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/android/exoplayer2/scheduler/c$a;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/google/android/exoplayer2/scheduler/c;->h:I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput p2, p0, Lcom/google/android/exoplayer2/scheduler/c;->a:I

    new-instance p2, Landroid/content/ComponentName;

    const-class v0, Lcom/google/android/exoplayer2/scheduler/c$a;

    invoke-direct {p2, p1, v0}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    iput-object p2, p0, Lcom/google/android/exoplayer2/scheduler/c;->b:Landroid/content/ComponentName;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/scheduler/c;->c:Landroid/app/job/JobScheduler;
...
.method private static a(ILandroid/content/ComponentName;Lcom/google/android/exoplayer2/scheduler/Requirements;Ljava/lang/String;Ljava/lang/String;)Landroid/app/job/JobInfo;
    ...
    sget v0, Lcom/google/android/exoplayer2/scheduler/c;->h:I
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/scheduler/Requirements;->a()I

    move-result v0

    invoke-virtual {p2}, Lcom/google/android/exoplayer2/scheduler/Requirements;->a()I
    ...
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/scheduler/Requirements;->f()Z
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/scheduler/Requirements;->d()Z
    ...
    :cond_2
    :goto_0
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/scheduler/Requirements;->c()Z

    move-result p0

    invoke-virtual {v0, p0}, Landroid/app/job/JobInfo$Builder;->setRequiresDeviceIdle(Z)Landroid/app/job/JobInfo$Builder;

    invoke-virtual {p2}, Lcom/google/android/exoplayer2/scheduler/Requirements;->b()Z
...
.method public a(Lcom/google/android/exoplayer2/scheduler/Requirements;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    iget v0, p0, Lcom/google/android/exoplayer2/scheduler/c;->a:I

    iget-object v1, p0, Lcom/google/android/exoplayer2/scheduler/c;->b:Landroid/content/ComponentName;

    invoke-static {v0, v1, p1, p3, p2}, Lcom/google/android/exoplayer2/scheduler/c;->a(ILandroid/content/ComponentName;Lcom/google/android/exoplayer2/scheduler/Requirements;Ljava/lang/String;Ljava/lang/String;)Landroid/app/job/JobInfo;

    move-result-object p1

    iget-object p2, p0, Lcom/google/android/exoplayer2/scheduler/c;->c:Landroid/app/job/JobScheduler;
...
.method public cancel()Z
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/scheduler/c;->c:Landroid/app/job/JobScheduler;

    iget v1, p0, Lcom/google/android/exoplayer2/scheduler/c;->a:I
