...
.method constructor <init>(Ljava/util/Comparator;Ljava/util/Comparator;)V
    ...
    new-instance p1, Le/f/d/d/r6$c;

    invoke-direct {p1, p2}, Le/f/d/d/r6$c;-><init>(Ljava/util/Comparator;)V

    invoke-direct {p0, v0, p1}, Le/f/d/d/j6;-><init>(Ljava/util/SortedMap;Le/f/d/b/m0;)V

    iput-object p2, p0, Le/f/d/d/r6;->j:Ljava/util/Comparator;

    return-void
.end method

.method public static a(Le/f/d/d/r6;)Le/f/d/d/r6;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    new-instance v0, Le/f/d/d/r6;

    invoke-virtual {p0}, Le/f/d/d/r6;->j()Ljava/util/Comparator;

    move-result-object v1

    invoke-virtual {p0}, Le/f/d/d/r6;->i()Ljava/util/Comparator;

    move-result-object v2

    invoke-direct {v0, v1, v2}, Le/f/d/d/r6;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V

    invoke-virtual {v0, p0}, Le/f/d/d/r6;->a(Le/f/d/d/m6;)V

    return-object v0
.end method

.method public static a(Ljava/util/Comparator;Ljava/util/Comparator;)Le/f/d/d/r6;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R:",
    ...
    invoke-direct {v0, p0, p1}, Le/f/d/d/r6;-><init>(Ljava/util/Comparator;Ljava/util/Comparator;)V

    return-object v0
.end method

.method public static k()Le/f/d/d/r6;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<R::",
...
.method public bridge synthetic d()Ljava/util/Set;
    ...
    invoke-virtual {p0}, Le/f/d/d/r6;->d()Ljava/util/SortedSet;
...
.method public d()Ljava/util/SortedSet;
    ...
    invoke-super {p0}, Le/f/d/d/j6;->d()Ljava/util/SortedSet;
...
.method public bridge synthetic f()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Le/f/d/d/r6;->f()Ljava/util/SortedMap;
...
.method public f()Ljava/util/SortedMap;
    ...
    invoke-super {p0}, Le/f/d/d/j6;->f()Ljava/util/SortedMap;
...
.method g()Ljava/util/Iterator;
    ...
    new-instance v2, Le/f/d/d/r6$a;

    invoke-direct {v2, p0}, Le/f/d/d/r6$a;-><init>(Le/f/d/d/r6;)V

    invoke-static {v1, v2}, Le/f/d/d/a4;->a(Ljava/lang/Iterable;Le/f/d/b/s;)Ljava/lang/Iterable;

    move-result-object v1

    invoke-static {v1, v0}, Le/f/d/d/b4;->a(Ljava/lang/Iterable;Ljava/util/Comparator;)Le/f/d/d/x6;

    move-result-object v1

    new-instance v2, Le/f/d/d/r6$b;

    invoke-direct {v2, p0, v1, v0}, Le/f/d/d/r6$b;-><init>(Le/f/d/d/r6;Ljava/util/Iterator;Ljava/util/Comparator;)V
...
.method public i()Ljava/util/Comparator;
    ...
    iget-object v0, p0, Le/f/d/d/r6;->j:Ljava/util/Comparator;
...
.method public bridge synthetic k(Ljava/lang/Object;)Ljava/util/Map;
    ...
    invoke-virtual {p0, p1}, Le/f/d/d/r6;->k(Ljava/lang/Object;)Ljava/util/SortedMap;
...
.method public k(Ljava/lang/Object;)Ljava/util/SortedMap;
    ...
    invoke-direct {v0, p0, p1}, Le/f/d/d/r6$d;-><init>(Le/f/d/d/r6;Ljava/lang/Object;)V
