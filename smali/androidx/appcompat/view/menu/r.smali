...
.field p0:Landroid/view/ViewTreeObserver;
...
.method static constructor <clinit>()V
    ...
    sget v0, Lc/a/a$j;->abc_popup_menu_item_layout:I

    sput v0, Landroidx/appcompat/view/menu/r;->v0:I
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iput v0, p0, Landroidx/appcompat/view/menu/r;->t0:I
    ...
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/r;->e:Z

    sget v2, Landroidx/appcompat/view/menu/r;->v0:I
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/r;->d:Landroidx/appcompat/view/menu/f;
    ...
    sget p6, Lc/a/a$e;->abc_config_prefDialogWidth:I
    ...
    iput p4, p0, Landroidx/appcompat/view/menu/r;->f:I

    iput-object p3, p0, Landroidx/appcompat/view/menu/r;->m:Landroid/view/View;

    new-instance p3, Landroidx/appcompat/widget/k0;

    iget-object p4, p0, Landroidx/appcompat/view/menu/r;->b:Landroid/content/Context;

    iget p5, p0, Landroidx/appcompat/view/menu/r;->g:I

    iget p6, p0, Landroidx/appcompat/view/menu/r;->h:I

    const/4 v0, 0x0

    invoke-direct {p3, p4, v0, p5, p6}, Landroidx/appcompat/widget/k0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;
...
.method private f()Z
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/appcompat/view/menu/r;->q0:Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/r;->p0:Landroid/view/ViewTreeObserver;
    ...
    iput-object v4, p0, Landroidx/appcompat/view/menu/r;->p0:Landroid/view/ViewTreeObserver;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/i0;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;

    iget v3, p0, Landroidx/appcompat/view/menu/r;->t0:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/i0;->g(I)V

    iget-boolean v0, p0, Landroidx/appcompat/view/menu/r;->r0:Z
    ...
    iput v0, p0, Landroidx/appcompat/view/menu/r;->s0:I

    iput-boolean v1, p0, Landroidx/appcompat/view/menu/r;->r0:Z

    :cond_4
    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;

    iget v4, p0, Landroidx/appcompat/view/menu/r;->s0:I
    ...
    iget-boolean v4, p0, Landroidx/appcompat/view/menu/r;->u0:Z

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroidx/appcompat/view/menu/r;->c:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v4}, Landroidx/appcompat/view/menu/g;->i()Ljava/lang/CharSequence;
    ...
    sget v5, Lc/a/a$j;->abc_popup_menu_header_item_layout:I
    ...
    invoke-virtual {v6}, Landroidx/appcompat/view/menu/g;->i()Ljava/lang/CharSequence;
...
.method public a(I)V
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/r;->t0:I
...
.method public a(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->o0:Landroidx/appcompat/view/menu/n$a;
...
.method public a(Landroidx/appcompat/view/menu/n$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/r;->o0:Landroidx/appcompat/view/menu/n$a;
...
.method public a(Landroidx/appcompat/view/menu/s;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/r;->o0:Landroidx/appcompat/view/menu/n$a;
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/r;->i:Landroidx/appcompat/widget/k0;
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/i0;->e()I

    move-result v3

    iget v4, p0, Landroidx/appcompat/view/menu/r;->t0:I

    iget-object v5, p0, Landroidx/appcompat/view/menu/r;->m:Landroid/view/View;

    invoke-static {v5}, Lc/i/o/e0;->y(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {v0, v2, v3}, Landroidx/appcompat/view/menu/m;->b(II)Z
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/r;->r0:Z
...
.method public c(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/r;->u0:Z
...
.method public onDismiss()V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/r;->q0:Z

    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->c:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v0}, Landroidx/appcompat/view/menu/g;->close()V

    iget-object v0, p0, Landroidx/appcompat/view/menu/r;->p0:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/r;->p0:Landroid/view/ViewTreeObserver;
