...
.method private a(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    .locals 2
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
...
.method private a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Le/f/b/b/b/i;FF)F
    .locals 8
    ...
    invoke-virtual {p2}, Le/f/b/b/b/i;->a()J

    move-result-wide v0

    invoke-virtual {p2}, Le/f/b/b/b/i;->b()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Le/f/b/b/b/h;->b(Ljava/lang/String;)Le/f/b/b/b/i;

    move-result-object p1

    invoke-virtual {p1}, Le/f/b/b/b/i;->a()J

    move-result-wide v4

    invoke-virtual {p1}, Le/f/b/b/b/i;->b()J
    ...
    invoke-virtual {p2}, Le/f/b/b/b/i;->c()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Le/f/b/b/b/a;->a(FFF)F
...
.method private a(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Le/f/b/b/b/h;->b(Ljava/lang/String;)Le/f/b/b/b/i;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Le/f/b/b/b/h;->b(Ljava/lang/String;)Le/f/b/b/b/i;
...
.method private a(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F

    move-result v0

    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    ...
    check-cast v1, Le/f/b/b/b/i;

    iget-object p4, p4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast p4, Le/f/b/b/b/i;
    ...
    invoke-virtual {v1, v0}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {p4, p1}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    instance-of v1, v8, Le/f/b/b/f/g;
    ...
    check-cast v13, Le/f/b/b/f/g;

    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->b(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Le/f/b/b/b/h;->b(Ljava/lang/String;)Le/f/b/b/b/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Le/f/b/b/f/g$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Le/f/b/b/f/g;->setRevealInfo(Le/f/b/b/f/g$e;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v13}, Le/f/b/b/f/g;->getRevealInfo()Le/f/b/b/f/g$e;

    move-result-object v0

    iget v0, v0, Le/f/b/b/f/g$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Le/f/b/b/m/a;->a(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Le/f/b/b/f/a;->a(Le/f/b/b/f/g;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Le/f/b/b/f/g;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Le/f/b/b/b/i;->a()J
    ...
    iget v6, v0, Le/f/b/b/f/g$e;->c:F

    invoke-static {v13, v1, v10, v11}, Le/f/b/b/f/a;->a(Le/f/b/b/f/g;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Le/f/b/b/b/i;->b()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;

    invoke-virtual {v0}, Le/f/b/b/b/h;->a()J
    ...
    :goto_0
    invoke-virtual {v14, v9}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Le/f/b/b/f/a;->a(Le/f/b/b/f/g;)Landroid/animation/Animator$AnimatorListener;
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_0
    instance-of p1, p2, Le/f/b/b/f/g;

    if-eqz p1, :cond_1

    sget p1, Le/f/b/b/f/d;->o:I
    ...
    sget-object p3, Le/f/b/b/b/d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p2, Le/f/b/b/b/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Le/f/b/b/b/h;
    ...
    invoke-virtual {p2, p1}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F

    move-result v4

    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Le/f/b/b/b/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    ...
    check-cast v12, Le/f/b/b/b/i;

    iget-object v5, v5, Landroid/util/Pair;->second:Ljava/lang/Object;

    move-object v13, v5

    check-cast v13, Le/f/b/b/b/i;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Le/f/b/b/b/i;Le/f/b/b/b/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v12, v14}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V
...
.method private a(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Le/f/b/b/b/i;Le/f/b/b/b/i;FFFFLandroid/graphics/RectF;)V
    .locals 0
    .param p1    # Landroid/view/View;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    ...
    .param p2    # Lcom/google/android/material/transformation/FabTransformationBehavior$e;
        ...
        .end annotation
    .end param
    .param p3    # Le/f/b/b/b/i;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    .end param
    .param p4    # Le/f/b/b/b/i;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    .end param
    ...
    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Le/f/b/b/b/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->a(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Le/f/b/b/b/i;FF)F
...
.method private b(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    .locals 2
    .param p1    # Landroid/view/View;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->d(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
...
.method private b(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    sget v0, Le/f/b/b/a$h;->mtrl_child_content_container:I
...
.method private b(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of p7, p2, Le/f/b/b/f/g;
    ...
    invoke-interface {p2, p1}, Le/f/b/b/f/g;->setCircularRevealScrimColor(I)V

    :cond_1
    sget-object p1, Le/f/b/b/f/g$d;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p3, Le/f/b/b/f/g$d;->a:Landroid/util/Property;
    ...
    :goto_0
    invoke-static {}, Le/f/b/b/b/c;->a()Le/f/b/b/b/c;
...
.method private c(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    .locals 2
    .param p1    # Landroid/view/View;
        .annotation build Landroidx/annotation/h0;
        .end annotation
...
.method private c(Landroid/view/View;)I
    ...
    invoke-static {p1}, Lc/i/o/e0;->o(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method private d(Landroid/view/View;Landroid/view/View;Le/f/b/b/b/j;)F
    .locals 2
    .param p1    # Landroid/view/View;
        .annotation build Landroidx/annotation/h0;
        .end annotation
...
.method private d(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    instance-of v0, p2, Le/f/b/b/f/g;
    ...
    :cond_2
    sget-object p3, Le/f/b/b/b/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Le/f/b/b/b/h;->b(Ljava/lang/String;)Le/f/b/b/b/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Le/f/b/b/b/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Le/f/b/b/f/g;Landroid/graphics/drawable/Drawable;)V
...
.method protected b(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Le/f/b/b/b/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
