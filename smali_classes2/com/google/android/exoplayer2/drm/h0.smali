...
.method public constructor <init>(Ljava/lang/String;Lcom/google/android/exoplayer2/upstream/f0$c;)V
    ...
    invoke-direct {p0, p1, v0, p2}, Lcom/google/android/exoplayer2/drm/h0;-><init>(Ljava/lang/String;ZLcom/google/android/exoplayer2/upstream/f0$c;)V
...
.method public constructor <init>(Ljava/lang/String;ZLcom/google/android/exoplayer2/upstream/f0$c;)V
    ...
    iput-object p3, p0, Lcom/google/android/exoplayer2/drm/h0;->a:Lcom/google/android/exoplayer2/upstream/f0$c;

    iput-object p1, p0, Lcom/google/android/exoplayer2/drm/h0;->b:Ljava/lang/String;

    iput-boolean p2, p0, Lcom/google/android/exoplayer2/drm/h0;->c:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/drm/h0;->d:Ljava/util/Map;
...
.method private static a(Lcom/google/android/exoplayer2/upstream/f0$c;Ljava/lang/String;[BLjava/util/Map;)[B
    ...
    :try_start_1
    invoke-static {p2}, Lcom/google/android/exoplayer2/o2/s0;->a(Ljava/io/InputStream;)[B
    ...
    :try_start_2
    invoke-static {p2}, Lcom/google/android/exoplayer2/o2/s0;->a(Ljava/io/Closeable;)V
    :try_end_2
    ...
    :try_start_3
    invoke-static {p3, p0}, Lcom/google/android/exoplayer2/drm/h0;->a(Lcom/google/android/exoplayer2/upstream/f0$f;I)Ljava/lang/String;
    ...
    new-instance p0, Lcom/google/android/exoplayer2/drm/l0;
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/upstream/q0;->getResponseHeaders()Ljava/util/Map;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/google/android/exoplayer2/drm/l0;-><init>(Lcom/google/android/exoplayer2/upstream/t;Landroid/net/Uri;Ljava/util/Map;JLjava/lang/Throwable;)V
...
.method public a()V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/drm/h0;->d:Ljava/util/Map;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/drm/h0;->d:Ljava/util/Map;
...
.method public a(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/e0$b;)[B
    ...
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/e0$b;->b()Ljava/lang/String;

    move-result-object v0

    iget-boolean v1, p0, Lcom/google/android/exoplayer2/drm/h0;->c:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/drm/h0;->b:Ljava/lang/String;
    ...
    sget-object v2, Lcom/google/android/exoplayer2/j0;->J1:Ljava/util/UUID;
    ...
    :cond_2
    sget-object v2, Lcom/google/android/exoplayer2/j0;->H1:Ljava/util/UUID;
    ...
    :cond_4
    iget-object p1, p0, Lcom/google/android/exoplayer2/drm/h0;->d:Ljava/util/Map;

    monitor-enter p1

    :try_start_0
    iget-object v2, p0, Lcom/google/android/exoplayer2/drm/h0;->d:Ljava/util/Map;
    ...
    iget-object p1, p0, Lcom/google/android/exoplayer2/drm/h0;->a:Lcom/google/android/exoplayer2/upstream/f0$c;

    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/e0$b;->a()[B

    move-result-object p2

    invoke-static {p1, v0, p2, v1}, Lcom/google/android/exoplayer2/drm/h0;->a(Lcom/google/android/exoplayer2/upstream/f0$c;Ljava/lang/String;[BLjava/util/Map;)[B
    ...
    :cond_5
    new-instance p1, Lcom/google/android/exoplayer2/drm/l0;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/google/android/exoplayer2/drm/l0;-><init>(Lcom/google/android/exoplayer2/upstream/t;Landroid/net/Uri;Ljava/util/Map;JLjava/lang/Throwable;)V
...
.method public a(Ljava/util/UUID;Lcom/google/android/exoplayer2/drm/e0$h;)[B
    ...
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/e0$h;->b()Ljava/lang/String;
    ...
    invoke-virtual {p2}, Lcom/google/android/exoplayer2/drm/e0$h;->a()[B
    ...
    iget-object p2, p0, Lcom/google/android/exoplayer2/drm/h0;->a:Lcom/google/android/exoplayer2/upstream/f0$c;
    ...
    invoke-static {p2, p1, v1, v0}, Lcom/google/android/exoplayer2/drm/h0;->a(Lcom/google/android/exoplayer2/upstream/f0$c;Ljava/lang/String;[BLjava/util/Map;)[B
