...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/h0;->a:Lc/f/i;

    new-instance v0, Lc/f/f;

    invoke-direct {v0}, Lc/f/f;-><init>()V

    iput-object v0, p0, Landroidx/recyclerview/widget/h0;->b:Lc/f/f;

    return-void
.end method

.method private a(Landroidx/recyclerview/widget/RecyclerView$e0;I)Landroidx/recyclerview/widget/RecyclerView$l$d;
    .locals 4

    iget-object v0, p0, Landroidx/recyclerview/widget/h0;->a:Lc/f/i;
    ...
    :cond_0
    iget-object v1, p0, Landroidx/recyclerview/widget/h0;->a:Lc/f/i;

    invoke-virtual {v1, p1}, Lc/f/i;->d(I)Ljava/lang/Object;
...
# virtual methods
.method a(J)Landroidx/recyclerview/widget/RecyclerView$e0;
    .locals 1

    iget-object v0, p0, Landroidx/recyclerview/widget/h0;->b:Lc/f/f;
...
.method a()V
    ...
    invoke-virtual {v0}, Lc/f/f;->clear()V

    return-void
.end method

.method a(JLandroidx/recyclerview/widget/RecyclerView$e0;)V
    .locals 1

    iget-object v0, p0, Landroidx/recyclerview/widget/h0;->b:Lc/f/f;

    invoke-virtual {v0, p1, p2, p3}, Lc/f/f;->c(JLjava/lang/Object;)V
...
.method a(Landroidx/recyclerview/widget/h0$b;)V
    ...
    invoke-virtual {v1, v0}, Lc/f/i;->b(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroidx/recyclerview/widget/RecyclerView$e0;

    iget-object v2, p0, Landroidx/recyclerview/widget/h0;->a:Lc/f/i;

    invoke-virtual {v2, v0}, Lc/f/i;->c(I)Ljava/lang/Object;
    ...
    invoke-interface {p1, v1, v3, v4}, Landroidx/recyclerview/widget/h0$b;->a(Landroidx/recyclerview/widget/RecyclerView$e0;Landroidx/recyclerview/widget/RecyclerView$l$d;Landroidx/recyclerview/widget/RecyclerView$l$d;)V
...
.method b(Landroidx/recyclerview/widget/RecyclerView$e0;Landroidx/recyclerview/widget/RecyclerView$l$d;)V
    .locals 2
...
.method c(Landroidx/recyclerview/widget/RecyclerView$e0;Landroidx/recyclerview/widget/RecyclerView$l$d;)V
    .locals 2
...
.method c(Landroidx/recyclerview/widget/RecyclerView$e0;)Z
    .locals 1
...
.method public d(Landroidx/recyclerview/widget/RecyclerView$e0;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/h0;->g(Landroidx/recyclerview/widget/RecyclerView$e0;)V

    return-void
.end method

.method e(Landroidx/recyclerview/widget/RecyclerView$e0;)Landroidx/recyclerview/widget/RecyclerView$l$d;
    .locals 1
    ...
    invoke-direct {p0, p1, v0}, Landroidx/recyclerview/widget/h0;->a(Landroidx/recyclerview/widget/RecyclerView$e0;I)Landroidx/recyclerview/widget/RecyclerView$l$d;
...
.method f(Landroidx/recyclerview/widget/RecyclerView$e0;)Landroidx/recyclerview/widget/RecyclerView$l$d;
    .locals 1
    .annotation build Landroidx/annotation/i0;
    .end annotation
...
.method h(Landroidx/recyclerview/widget/RecyclerView$e0;)V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/h0;->b:Lc/f/f;

    invoke-virtual {v1, v0}, Lc/f/f;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lc/f/f;->b(I)V
