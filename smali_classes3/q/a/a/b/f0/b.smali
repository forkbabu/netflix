...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lq/a/a/b/f0/b;->f:[[I
...
.method public static a(Ljava/util/Calendar;Ljava/util/Calendar;I)I
    ...
    invoke-static {p0, p2}, Lq/a/a/b/f0/b;->i(Ljava/util/Calendar;I)Ljava/util/Calendar;

    move-result-object p0

    invoke-static {p1, p2}, Lq/a/a/b/f0/b;->i(Ljava/util/Calendar;I)Ljava/util/Calendar;
...
.method public static a(Ljava/util/Date;Ljava/util/Date;I)I
    ...
    invoke-static {p0, p2}, Lq/a/a/b/f0/b;->x(Ljava/util/Date;I)Ljava/util/Date;

    move-result-object p0

    invoke-static {p1, p2}, Lq/a/a/b/f0/b;->x(Ljava/util/Date;I)Ljava/util/Date;
...
.method private static a(Ljava/util/Calendar;II)J
    ...
    invoke-static {p2}, Lq/a/a/b/f0/b;->a(I)J
...
.method public static a(Ljava/util/Calendar;I)Ljava/util/Calendar;
    ...
    invoke-static {p0, p1, v0}, Lq/a/a/b/f0/b;->b(Ljava/util/Calendar;II)V
...
.method public static a(Ljava/lang/Object;I)Ljava/util/Date;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->i(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->a(Ljava/util/Calendar;I)Ljava/util/Calendar;
...
.method public static varargs a(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/Date;
    ...
    invoke-static {p0, p1, v0}, Lq/a/a/b/f0/b;->a(Ljava/lang/String;[Ljava/lang/String;Z)Ljava/util/Date;
...
.method public static a(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {p0, v0, p1}, Lq/a/a/b/f0/b;->a(Ljava/util/Date;II)Ljava/util/Date;
...
.method public static a(Ljava/util/Date;Ljava/util/Date;)Z
    ...
    invoke-static {v0, p0}, Lq/a/a/b/f0/b;->a(Ljava/util/Calendar;Ljava/util/Calendar;)Z
...
.method public static b(Ljava/util/Calendar;I)J
    ...
    invoke-static {p0, p1, v0}, Lq/a/a/b/f0/b;->a(Ljava/util/Calendar;II)J
...
.method private static b(Ljava/util/Date;II)J
    .locals 1
    ...
    invoke-static {v0, p1, p2}, Lq/a/a/b/f0/b;->a(Ljava/util/Calendar;II)J
...
.method public static b(Ljava/lang/Object;I)Ljava/util/Iterator;
    .locals 2
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->o(Ljava/util/Date;I)Ljava/util/Iterator;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->g(Ljava/util/Calendar;I)Ljava/util/Iterator;
...
.method private static b(Ljava/util/Calendar;II)V
    .locals 16
    ...
    :cond_9
    sget-object v5, Lq/a/a/b/f0/b;->f:[[I
...
.method public static b(Ljava/util/Calendar;Ljava/util/Calendar;I)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lq/a/a/b/f0/b;->a(Ljava/util/Calendar;Ljava/util/Calendar;I)I
...
.method public static b(Ljava/util/Date;Ljava/util/Date;I)Z
    .locals 0

    invoke-static {p0, p1, p2}, Lq/a/a/b/f0/b;->a(Ljava/util/Date;Ljava/util/Date;I)I
...
.method public static c(Ljava/lang/Object;I)Ljava/util/Date;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->p(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->h(Ljava/util/Calendar;I)Ljava/util/Calendar;
...
.method private static c(Ljava/util/Date;II)Ljava/util/Date;
    .locals 2
...
.method public static d(Ljava/lang/Object;I)Ljava/util/Date;
    .locals 2
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->x(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {p0, p1}, Lq/a/a/b/f0/b;->i(Ljava/util/Calendar;I)Ljava/util/Calendar;
...
.method public static g(Ljava/util/Calendar;I)Ljava/util/Iterator;
    ...
    :pswitch_0
    invoke-static {p0, v1}, Lq/a/a/b/f0/b;->i(Ljava/util/Calendar;I)Ljava/util/Calendar;
    ...
    :pswitch_1
    invoke-static {p0, v2}, Lq/a/a/b/f0/b;->i(Ljava/util/Calendar;I)Ljava/util/Calendar;
    ...
    :cond_9
    new-instance p0, Lq/a/a/b/f0/b$a;

    invoke-direct {p0, v5, v6}, Lq/a/a/b/f0/b$a;-><init>(Ljava/util/Calendar;Ljava/util/Calendar;)V
...
.method public static h(Ljava/util/Calendar;I)Ljava/util/Calendar;
    .locals 1
...
.method public static i(Ljava/util/Calendar;I)Ljava/util/Calendar;
    .locals 1
...
.method public static i(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {v0, p1, p0}, Lq/a/a/b/f0/b;->b(Ljava/util/Calendar;II)V
...
.method public static j(Ljava/util/Date;I)J
    .locals 1

    const/4 v0, 0x6

    invoke-static {p0, p1, v0}, Lq/a/a/b/f0/b;->b(Ljava/util/Date;II)J
...
.method public static k(Ljava/util/Date;I)J
    .locals 1
...
.method public static l(Ljava/util/Date;I)J
    .locals 1
...
.method public static n(Ljava/util/Date;I)J
    .locals 1
...
.method public static o(Ljava/util/Date;I)Ljava/util/Iterator;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p1}, Lq/a/a/b/f0/b;->g(Ljava/util/Calendar;I)Ljava/util/Iterator;
...
.method public static q(Ljava/util/Date;I)Ljava/util/Date;
    ...
    invoke-static {p0, v0, p1}, Lq/a/a/b/f0/b;->c(Ljava/util/Date;II)Ljava/util/Date;
