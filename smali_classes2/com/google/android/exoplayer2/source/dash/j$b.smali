...
# instance fields
.field final a:Lcom/google/android/exoplayer2/source/g1/f;
...
# direct methods
.method constructor <init>(JILcom/google/android/exoplayer2/source/dash/n/i;ZLjava/util/List;Lcom/google/android/exoplayer2/k2/d0;)V
    .locals 8
    .param p7    # Lcom/google/android/exoplayer2/k2/d0;
        .annotation build Landroidx/annotation/i0;
        .end annotation
    .end param
    ...
    invoke-static {p3, p4, p5, p6, p7}, Lcom/google/android/exoplayer2/source/dash/j$b;->a(ILcom/google/android/exoplayer2/source/dash/n/i;ZLjava/util/List;Lcom/google/android/exoplayer2/k2/d0;)Lcom/google/android/exoplayer2/source/g1/f;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/google/android/exoplayer2/source/dash/j$b;-><init>(JLcom/google/android/exoplayer2/source/dash/n/i;Lcom/google/android/exoplayer2/source/g1/f;JLcom/google/android/exoplayer2/source/dash/g;)V

    return-void
.end method

.method private constructor <init>(JLcom/google/android/exoplayer2/source/dash/n/i;Lcom/google/android/exoplayer2/source/g1/f;JLcom/google/android/exoplayer2/source/dash/g;)V
    .locals 0
    .param p4    # Lcom/google/android/exoplayer2/source/g1/f;
        .annotation build Landroidx/annotation/i0;
        .end annotation
    .end param
    ...
    iput-object p4, p0, Lcom/google/android/exoplayer2/source/dash/j$b;->a:Lcom/google/android/exoplayer2/source/g1/f;
...
.method private static a(ILcom/google/android/exoplayer2/source/dash/n/i;ZLjava/util/List;Lcom/google/android/exoplayer2/k2/d0;)Lcom/google/android/exoplayer2/source/g1/f;
    .locals 7
    .param p4    # Lcom/google/android/exoplayer2/k2/d0;
        .annotation build Landroidx/annotation/i0;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/i0;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lcom/google/android/exoplayer2/k2/d0;",
            ")",
            "Lcom/google/android/exoplayer2/source/g1/f;"
        }
    .end annotation

    iget-object v0, p1, Lcom/google/android/exoplayer2/source/dash/n/i;->c:Lcom/google/android/exoplayer2/Format;

    iget-object v0, v0, Lcom/google/android/exoplayer2/Format;->k:Ljava/lang/String;

    invoke-static {v0}, Lcom/google/android/exoplayer2/o2/x;->m(Ljava/lang/String;)Z
    ...
    new-instance p2, Lcom/google/android/exoplayer2/k2/n0/a;

    iget-object p3, p1, Lcom/google/android/exoplayer2/source/dash/n/i;->c:Lcom/google/android/exoplayer2/Format;

    invoke-direct {p2, p3}, Lcom/google/android/exoplayer2/k2/n0/a;-><init>(Lcom/google/android/exoplayer2/Format;)V
    ...
    :cond_1
    invoke-static {v0}, Lcom/google/android/exoplayer2/o2/x;->l(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    new-instance p2, Lcom/google/android/exoplayer2/k2/j0/e;

    const/4 p3, 0x1

    invoke-direct {p2, p3}, Lcom/google/android/exoplayer2/k2/j0/e;-><init>(I)V
    ...
    :goto_0
    new-instance p2, Lcom/google/android/exoplayer2/extractor/mp4/i;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/android/exoplayer2/extractor/mp4/i;-><init>(ILcom/google/android/exoplayer2/o2/o0;Lcom/google/android/exoplayer2/extractor/mp4/n;Ljava/util/List;Lcom/google/android/exoplayer2/k2/d0;)V

    :goto_1
    new-instance p3, Lcom/google/android/exoplayer2/source/g1/d;

    iget-object p1, p1, Lcom/google/android/exoplayer2/source/dash/n/i;->c:Lcom/google/android/exoplayer2/Format;

    invoke-direct {p3, p2, p0, p1}, Lcom/google/android/exoplayer2/source/g1/d;-><init>(Lcom/google/android/exoplayer2/k2/l;ILcom/google/android/exoplayer2/Format;)V
...
.method a(JLcom/google/android/exoplayer2/source/dash/n/i;)Lcom/google/android/exoplayer2/source/dash/j$b;
    ...
    iget-object v5, v0, Lcom/google/android/exoplayer2/source/dash/j$b;->a:Lcom/google/android/exoplayer2/source/g1/f;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/android/exoplayer2/source/dash/j$b;-><init>(JLcom/google/android/exoplayer2/source/dash/n/i;Lcom/google/android/exoplayer2/source/g1/f;JLcom/google/android/exoplayer2/source/dash/g;)V
...
.method a(Lcom/google/android/exoplayer2/source/dash/g;)Lcom/google/android/exoplayer2/source/dash/j$b;
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/source/dash/j$b;->a:Lcom/google/android/exoplayer2/source/g1/f;
