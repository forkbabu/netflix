...
.field private mOnChangePollingClient:Lo/b0;
    .annotation runtime Lm/a/h;
    .end annotation
.end field
...
.method public constructor <init>(Lcom/facebook/react/devsupport/DevInternalSettings;Ljava/lang/String;)V
    ...
    new-instance p1, Lo/b0$b;

    invoke-direct {p1}, Lo/b0$b;-><init>()V

    sget-object v0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    const-wide/16 v1, 0x1388

    invoke-virtual {p1, v1, v2, v0}, Lo/b0$b;->b(JLjava/util/concurrent/TimeUnit;)Lo/b0$b;
    ...
    invoke-virtual {p1, v1, v2, v0}, Lo/b0$b;->d(JLjava/util/concurrent/TimeUnit;)Lo/b0$b;

    move-result-object p1

    sget-object v0, Ljava/util/concurrent/TimeUnit;->MILLISECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {p1, v1, v2, v0}, Lo/b0$b;->e(JLjava/util/concurrent/TimeUnit;)Lo/b0$b;
    ...
    iput-object p1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mClient:Lo/b0;

    new-instance v0, Lcom/facebook/react/devsupport/BundleDownloader;

    invoke-direct {v0, p1}, Lcom/facebook/react/devsupport/BundleDownloader;-><init>(Lo/b0;)V
...
.method private enqueueOnChangeEndpointLongPolling()V
    ...
    invoke-virtual {v0, p0}, Lo/f0$a;->a(Ljava/lang/Object;)Lo/f0$a;
    ...
    iget-object v1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mOnChangePollingClient:Lo/b0;
...
.method public downloadBundleResourceFromUrlSync(Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual {v1, v0}, Lo/f0$a;->b(Ljava/lang/String;)Lo/f0$a;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mClient:Lo/b0;
    ...
    :cond_0
    :try_start_1
    invoke-static {p2}, Lp/p;->b(Ljava/io/File;)Lp/x;
    ...
    invoke-interface {v0, v2}, Lp/e;->a(Lp/x;)J
    :try_end_2
    ...
    :try_start_3
    invoke-interface {v2}, Lp/x;->close()V
...
.method public isPackagerRunning(Lcom/facebook/react/devsupport/interfaces/PackagerStatusCallback;)V
    ...
    iget-object v1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mClient:Lo/b0;
...
.method public openStackFrameCall(Lcom/facebook/react/devsupport/interfaces/StackFrame;)V
    ...
    invoke-static {v1}, Lo/z;->b(Ljava/lang/String;)Lo/z;
    ...
    invoke-static {v1, p1}, Lo/g0;->create(Lo/z;Ljava/lang/String;)Lo/g0;

    move-result-object p1

    invoke-virtual {v0, p1}, Lo/f0$a;->c(Lo/g0;)Lo/f0$a;
    ...
    iget-object v0, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mClient:Lo/b0;

    invoke-virtual {v0, p1}, Lo/b0;->a(Lo/f0;)Lo/e;
    ...
    invoke-interface {p1, v0}, Lo/e;->a(Lo/f;)V
...
.method public startPollingOnChangeEndpoint(Lcom/facebook/react/devsupport/DevServerHelper$OnServerContentChangeListener;)V
    ...
    invoke-direct {v1, v0, v2, v3, v4}, Lo/k;-><init>(IJLjava/util/concurrent/TimeUnit;)V

    invoke-virtual {p1, v1}, Lo/b0$b;->a(Lo/k;)Lo/b0$b;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lo/b0$b;->b(JLjava/util/concurrent/TimeUnit;)Lo/b0$b;
    ...
    iput-object p1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mOnChangePollingClient:Lo/b0;
...
.method public stopPollingOnChangeEndpoint()V
    ...
    iget-object v0, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mOnChangePollingClient:Lo/b0;

    if-eqz v0, :cond_0

    invoke-static {v0, p0}, Lcom/facebook/react/common/network/OkHttpCallUtil;->cancelTag(Lo/b0;Ljava/lang/Object;)V

    iput-object v1, p0, Lcom/facebook/react/devsupport/DevServerHelper;->mOnChangePollingClient:Lo/b0;
...
.method public symbolicateStackTrace(Ljava/lang/Iterable;Lcom/facebook/react/devsupport/DevServerHelper$SymbolicationListener;)V
    ...
    invoke-virtual {p1, v0}, Lo/f0$a;->b(Ljava/lang/String;)Lo/f0$a;
    ...
    invoke-static {v0, v1}, Lo/g0;->create(Lo/z;Ljava/lang/String;)Lo/g0;

    move-result-object v0

    invoke-virtual {p1, v0}, Lo/f0$a;->c(Lo/g0;)Lo/f0$a;
