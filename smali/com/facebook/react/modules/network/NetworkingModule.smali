...
# instance fields
.field private final mClient:Lo/b0;
...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;)V
    ...
    invoke-direct {p0, p1, v1, v0, v1}, Lcom/facebook/react/modules/network/NetworkingModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;Ljava/util/List;)V
...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/facebook/react/modules/network/NetworkingModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;Ljava/util/List;)V

    return-void
.end method

.method constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/facebook/react/modules/network/NetworkingModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;Ljava/util/List;)V

    return-void
.end method

.method constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;Ljava/util/List;)V
    .locals 1
    .param p2    # Ljava/lang/String;
        .annotation runtime Lm/a/h;
        .end annotation
    ...
    invoke-virtual {p3}, Lo/b0;->u()Lo/b0$b;
    ...
    invoke-interface {v0}, Lcom/facebook/react/modules/network/NetworkInterceptorCreator;->create()Lo/w;

    move-result-object v0

    invoke-virtual {p3, v0}, Lo/b0$b;->b(Lo/w;)Lo/b0$b;

    goto :goto_0

    :cond_0
    invoke-virtual {p3}, Lo/b0$b;->a()Lo/b0;

    move-result-object p3

    :cond_1
    iput-object p3, p0, Lcom/facebook/react/modules/network/NetworkingModule;->mClient:Lo/b0;
    ...
    iget-object p1, p0, Lcom/facebook/react/modules/network/NetworkingModule;->mClient:Lo/b0;

    invoke-virtual {p1}, Lo/b0;->i()Lo/n;
...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/util/List;)V
    ...
    invoke-direct {p0, p1, v1, v0, p2}, Lcom/facebook/react/modules/network/NetworkingModule;-><init>(Lcom/facebook/react/bridge/ReactApplicationContext;Ljava/lang/String;Lo/b0;Ljava/util/List;)V
...
.method static synthetic access$300(Lo/u;)Lcom/facebook/react/bridge/WritableMap;
    .locals 0

    invoke-static {p0}, Lcom/facebook/react/modules/network/NetworkingModule;->translateHeaders(Lo/u;)Lcom/facebook/react/bridge/WritableMap;
...
.method static synthetic access$400(Lcom/facebook/react/modules/network/NetworkingModule;Lcom/facebook/react/modules/core/DeviceEventManagerModule$RCTDeviceEventEmitter;ILo/i0;)V
    .locals 0
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/facebook/react/modules/network/NetworkingModule;->readWithProgress(Lcom/facebook/react/modules/core/DeviceEventManagerModule$RCTDeviceEventEmitter;ILo/i0;)V

    return-void
.end method

.method static synthetic access$500(Lcom/facebook/react/modules/network/NetworkingModule;)Lo/b0;
    .locals 0

    iget-object p0, p0, Lcom/facebook/react/modules/network/NetworkingModule;->mClient:Lo/b0;
...
.method private constructMultipartBody(Lcom/facebook/react/bridge/ReadableArray;Ljava/lang/String;I)Lo/a0$a;
    .locals 9
    .annotation runtime Lm/a/h;
    .end annotation
    ...
    invoke-virtual {v1, p2}, Lo/a0$a;->a(Lo/z;)Lo/a0$a;
    ...
    invoke-direct {p0, v4, v5}, Lcom/facebook/react/modules/network/NetworkingModule;->extractHeaders(Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;)Lo/u;
    ...
    invoke-virtual {v4, v6}, Lo/u;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    if-eqz v7, :cond_1

    invoke-static {v7}, Lo/z;->b(Ljava/lang/String;)Lo/z;

    move-result-object v7

    invoke-virtual {v4}, Lo/u;->c()Lo/u$a;

    move-result-object v4

    invoke-virtual {v4, v6}, Lo/u$a;->d(Ljava/lang/String;)Lo/u$a;

    move-result-object v4

    invoke-virtual {v4}, Lo/u$a;->a()Lo/u;
    ...
    invoke-static {v7, v3}, Lo/g0;->create(Lo/z;Ljava/lang/String;)Lo/g0;

    move-result-object v3

    invoke-virtual {v1, v4, v3}, Lo/a0$a;->a(Lo/u;Lo/g0;)Lo/a0$a;
    ...
    :cond_4
    invoke-static {v7, v6}, Lcom/facebook/react/modules/network/RequestBodyUtil;->create(Lo/z;Ljava/io/InputStream;)Lo/g0;
...
.method private extractHeaders(Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;)Lo/u;
    .locals 9
    ...
    :cond_2
    invoke-virtual {v1, v7, v5}, Lo/u$a;->a(Ljava/lang/String;Ljava/lang/String;)Lo/u$a;
    ...
    invoke-virtual {v1, p1}, Lo/u$a;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, v0}, Lo/u$a;->a(Ljava/lang/String;Ljava/lang/String;)Lo/u$a;
    ...
    invoke-virtual {v1, p1}, Lo/u$a;->d(Ljava/lang/String;)Lo/u$a;
...
.method private readWithProgress(Lcom/facebook/react/modules/core/DeviceEventManagerModule$RCTDeviceEventEmitter;ILo/i0;)V
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :catch_1
    :goto_0
    invoke-virtual {p3}, Lo/i0;->charStream()Ljava/io/Reader;
...
.method private static translateHeaders(Lo/u;)Lcom/facebook/react/bridge/WritableMap;
    .locals 5
...
.method public initialize()V
    ...
    invoke-direct {v1, v2}, Lo/y;-><init>(Ljava/net/CookieHandler;)V

    invoke-interface {v0, v1}, Lcom/facebook/react/modules/network/CookieJarContainer;->setCookieJar(Lo/n;)V
...
.method public sendRequest(Ljava/lang/String;Ljava/lang/String;ILcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;Ljava/lang/String;ZIZ)V
    ...
    new-instance v4, Lo/f0$a;

    invoke-direct {v4}, Lo/f0$a;-><init>()V

    move-object/from16 v5, p2

    invoke-virtual {v4, v5}, Lo/f0$a;->b(Ljava/lang/String;)Lo/f0$a;
    ...
    invoke-virtual {v4, v5}, Lo/f0$a;->a(Ljava/lang/Object;)Lo/f0$a;
    ...
    iget-object v7, v6, Lcom/facebook/react/modules/network/NetworkingModule;->mClient:Lo/b0;

    invoke-virtual {v7}, Lo/b0;->u()Lo/b0$b;

    move-result-object v7

    if-nez p9, :cond_1

    sget-object v8, Lo/n;->a:Lo/n;

    invoke-virtual {v7, v8}, Lo/b0$b;->a(Lo/n;)Lo/b0$b;
    ...
    invoke-virtual {v7, v8}, Lo/b0$b;->b(Lo/w;)Lo/b0$b;
    ...
    :goto_0
    iget-object v8, v6, Lcom/facebook/react/modules/network/NetworkingModule;->mClient:Lo/b0;

    invoke-virtual {v8}, Lo/b0;->f()I
    ...
    invoke-virtual {v7, v10, v11, v3}, Lo/b0$b;->d(JLjava/util/concurrent/TimeUnit;)Lo/b0$b;

    :cond_3
    invoke-virtual {v7}, Lo/b0$b;->a()Lo/b0;

    move-result-object v3

    move-object/from16 v7, p4

    invoke-direct {p0, v7, v1}, Lcom/facebook/react/modules/network/NetworkingModule;->extractHeaders(Lcom/facebook/react/bridge/ReadableArray;Lcom/facebook/react/bridge/ReadableMap;)Lo/u;
    ...
    invoke-virtual {v7, v10}, Lo/u;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v10

    const-string v11, "content-encoding"

    invoke-virtual {v7, v11}, Lo/u;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v4, v7}, Lo/f0$a;->a(Lo/u;)Lo/f0$a;

    if-nez v1, :cond_5

    invoke-static {p1}, Lcom/facebook/react/modules/network/RequestBodyUtil;->getEmptyBody(Ljava/lang/String;)Lo/g0;

    move-result-object v1

    invoke-virtual {v4, p1, v1}, Lo/f0$a;->a(Ljava/lang/String;Lo/g0;)Lo/f0$a;
    ...
    invoke-static {v10}, Lo/z;->b(Ljava/lang/String;)Lo/z;
    ...
    invoke-static {v7, v1}, Lcom/facebook/react/modules/network/RequestBodyUtil;->createGzip(Lo/z;Ljava/lang/String;)Lo/g0;
    ...
    :cond_8
    invoke-static {v7, v1}, Lo/g0;->create(Lo/z;Ljava/lang/String;)Lo/g0;
    ...
    invoke-static {v1}, Lp/f;->a(Ljava/lang/String;)Lp/f;

    move-result-object v1

    invoke-static {v7, v1}, Lo/g0;->create(Lo/z;Lp/f;)Lo/g0;
    ...
    invoke-static {v1, v7}, Lcom/facebook/react/modules/network/RequestBodyUtil;->create(Lo/z;Ljava/io/InputStream;)Lo/g0;
    ...
    invoke-direct {p0, v1, v10, v2}, Lcom/facebook/react/modules/network/NetworkingModule;->constructMultipartBody(Lcom/facebook/react/bridge/ReadableArray;Ljava/lang/String;I)Lo/a0$a;
    ...
    invoke-static {v1, v7}, Lcom/facebook/react/modules/network/RequestBodyUtil;->createProgressRequest(Lo/g0;Lcom/facebook/react/modules/network/ProgressListener;)Lcom/facebook/react/modules/network/ProgressRequestBody;
    ...
    invoke-virtual {v4}, Lo/f0$a;->a()Lo/f0;

    move-result-object v0

    invoke-virtual {v3, v0}, Lo/b0;->a(Lo/f0;)Lo/e;
    ...
    invoke-interface {v7, v8}, Lo/e;->a(Lo/f;)V
