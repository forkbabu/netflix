...
.method public constructor <init>(Landroidx/lifecycle/l;)V
    ...
    iput-object v0, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;
    ...
    iput-object p1, p0, Landroidx/lifecycle/m;->c:Landroidx/lifecycle/h$b;
...
.method private a(Landroidx/lifecycle/l;)V
    ...
    iget-object v0, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;
    ...
    iget-object v4, p0, Landroidx/lifecycle/m;->c:Landroidx/lifecycle/h$b;
    ...
    iget-object v3, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;
    ...
    invoke-static {v3}, Landroidx/lifecycle/m;->c(Landroidx/lifecycle/h$b;)Landroidx/lifecycle/h$a;

    move-result-object v3

    invoke-static {v3}, Landroidx/lifecycle/m;->b(Landroidx/lifecycle/h$a;)Landroidx/lifecycle/h$b;

    move-result-object v4

    invoke-direct {p0, v4}, Landroidx/lifecycle/m;->e(Landroidx/lifecycle/h$b;)V
...
.method private b(Landroidx/lifecycle/l;)V
    ...
    invoke-virtual {v0}, Lc/b/a/c/b;->c()Lc/b/a/c/b$d;
    ...
    invoke-direct {p0, v3}, Landroidx/lifecycle/m;->e(Landroidx/lifecycle/h$b;)V
...
.method private static c(Landroidx/lifecycle/h$b;)Landroidx/lifecycle/h$a;
    .locals 3
...
.method private c(Landroidx/lifecycle/k;)Landroidx/lifecycle/h$b;
    .locals 2

    iget-object v0, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;

    invoke-virtual {v0, p1}, Lc/b/a/c/a;->b(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/lifecycle/m;->c:Landroidx/lifecycle/h$b;

    invoke-static {v1, p1}, Landroidx/lifecycle/m;->a(Landroidx/lifecycle/h$b;Landroidx/lifecycle/h$b;)Landroidx/lifecycle/h$b;

    move-result-object p1

    invoke-static {p1, v0}, Landroidx/lifecycle/m;->a(Landroidx/lifecycle/h$b;Landroidx/lifecycle/h$b;)Landroidx/lifecycle/h$b;
...
.method private c()Z
    ...
    invoke-virtual {v0}, Lc/b/a/c/b;->a()Ljava/util/Map$Entry;
    ...
    iget-object v2, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;

    invoke-virtual {v2}, Lc/b/a/c/b;->d()Ljava/util/Map$Entry;
    ...
    iget-object v0, p0, Landroidx/lifecycle/m;->c:Landroidx/lifecycle/h$b;
...
.method private d(Landroidx/lifecycle/h$b;)V
    ...
    invoke-direct {p0}, Landroidx/lifecycle/m;->e()V
...
.method private e()V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0}, Landroidx/lifecycle/m;->c()Z
    ...
    invoke-virtual {v2}, Lc/b/a/c/b;->a()Ljava/util/Map$Entry;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;

    invoke-virtual {v1}, Lc/b/a/c/b;->d()Ljava/util/Map$Entry;
    ...
    iget-object v2, p0, Landroidx/lifecycle/m;->c:Landroidx/lifecycle/h$b;
...
.method private e(Landroidx/lifecycle/h$b;)V
    .locals 1
...
.method public a(Landroidx/lifecycle/h$a;)V
    ...
    invoke-static {p1}, Landroidx/lifecycle/m;->b(Landroidx/lifecycle/h$a;)Landroidx/lifecycle/h$b;

    move-result-object p1

    invoke-direct {p0, p1}, Landroidx/lifecycle/m;->d(Landroidx/lifecycle/h$b;)V
...
.method public a(Landroidx/lifecycle/h$b;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/lifecycle/m;->b(Landroidx/lifecycle/h$b;)V
...
.method public a(Landroidx/lifecycle/k;)V
    ...
    invoke-virtual {v1, p1, v0}, Lc/b/a/c/a;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Landroidx/lifecycle/m;->b:Lc/b/a/c/a;
    ...
    invoke-static {v4}, Landroidx/lifecycle/m;->f(Landroidx/lifecycle/h$b;)Landroidx/lifecycle/h$a;
...
.method public b(Landroidx/lifecycle/k;)V
    ...
    invoke-virtual {v0, p1}, Lc/b/a/c/a;->remove(Ljava/lang/Object;)Ljava/lang/Object;
