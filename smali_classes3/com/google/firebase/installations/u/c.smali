...
.field private final b:Le/f/e/x/h;

.field private final c:Le/f/e/s/c;
...
.method public constructor <init>(Landroid/content/Context;Le/f/e/x/h;Le/f/e/s/c;)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/google/firebase/installations/u/c;->b:Le/f/e/x/h;

    iput-object p3, p0, Lcom/google/firebase/installations/u/c;->c:Le/f/e/s/c;
...
.method private a(Ljava/net/URL;Ljava/lang/String;)Ljava/net/HttpURLConnection;
    ...
    iget-object v0, p0, Lcom/google/firebase/installations/u/c;->c:Le/f/e/s/c;

    if-eqz v0, :cond_0

    iget-object v1, p0, Lcom/google/firebase/installations/u/c;->b:Le/f/e/x/h;

    if-eqz v1, :cond_0

    const-string v1, "fire-installations-id"

    invoke-interface {v0, v1}, Le/f/e/s/c;->a(Ljava/lang/String;)Le/f/e/s/c$a;

    move-result-object v0

    sget-object v1, Le/f/e/s/c$a;->b:Le/f/e/s/c$a;

    if-eq v0, v1, :cond_0

    iget-object v1, p0, Lcom/google/firebase/installations/u/c;->b:Le/f/e/x/h;

    invoke-interface {v1}, Le/f/e/x/h;->getUserAgent()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Le/f/e/s/c$a;->a()I
