...
.method static constructor <clinit>()V
    ...
    sget v0, Le/f/b/b/a$n;->Widget_Design_NavigationView:I

    sput v0, Lcom/google/android/material/navigation/NavigationView;->o0:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Le/f/b/b/a$c;->navigationViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v0, Lcom/google/android/material/navigation/NavigationView;->o0:I
    ...
    invoke-direct {v0, p1}, Lcom/google/android/material/internal/h;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/material/navigation/NavigationView;->f:Lcom/google/android/material/internal/h;

    sget-object v2, Le/f/b/b/a$o;->NavigationView:[I

    sget v4, Lcom/google/android/material/navigation/NavigationView;->o0:I
    ...
    sget p3, Le/f/b/b/a$o;->NavigationView_android_background:I
    ...
    invoke-virtual {v0, p3}, Le/f/b/b/r/j;->a(Landroid/content/res/ColorStateList;)V
    ...
    :cond_3
    sget p3, Le/f/b/b/a$o;->NavigationView_elevation:I
    ...
    invoke-virtual {p2, p3, v6}, Landroidx/appcompat/widget/y0;->c(II)I
    ...
    :cond_4
    sget p3, Le/f/b/b/a$o;->NavigationView_android_fitsSystemWindows:I

    invoke-virtual {p2, p3, v6}, Landroidx/appcompat/widget/y0;->a(IZ)Z

    move-result p3

    invoke-virtual {p0, p3}, Landroid/widget/FrameLayout;->setFitsSystemWindows(Z)V

    sget p3, Le/f/b/b/a$o;->NavigationView_android_maxWidth:I
    ...
    sget p3, Le/f/b/b/a$o;->NavigationView_itemIconTint:I
    ...
    :goto_0
    sget v0, Le/f/b/b/a$o;->NavigationView_itemTextAppearance:I
    ...
    invoke-virtual {p2, v0, v6}, Landroidx/appcompat/widget/y0;->g(II)I
    ...
    :goto_1
    sget v3, Le/f/b/b/a$o;->NavigationView_itemIconSize:I

    invoke-virtual {p2, v3}, Landroidx/appcompat/widget/y0;->j(I)Z
    ...
    invoke-virtual {p2, v3, v6}, Landroidx/appcompat/widget/y0;->c(II)I
    ...
    sget v4, Le/f/b/b/a$o;->NavigationView_itemTextColor:I

    invoke-virtual {p2, v4}, Landroidx/appcompat/widget/y0;->j(I)Z

    move-result v4

    if-eqz v4, :cond_8

    sget v3, Le/f/b/b/a$o;->NavigationView_itemTextColor:I

    invoke-virtual {p2, v3}, Landroidx/appcompat/widget/y0;->a(I)Landroid/content/res/ColorStateList;
    ...
    :cond_9
    sget v4, Le/f/b/b/a$o;->NavigationView_itemBackground:I

    invoke-virtual {p2, v4}, Landroidx/appcompat/widget/y0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    if-nez v4, :cond_a

    invoke-direct {p0, p2}, Lcom/google/android/material/navigation/NavigationView;->b(Landroidx/appcompat/widget/y0;)Z

    move-result v5

    if-eqz v5, :cond_a

    invoke-direct {p0, p2}, Lcom/google/android/material/navigation/NavigationView;->a(Landroidx/appcompat/widget/y0;)Landroid/graphics/drawable/Drawable;

    move-result-object v4

    :cond_a
    sget v5, Le/f/b/b/a$o;->NavigationView_itemHorizontalPadding:I

    invoke-virtual {p2, v5}, Landroidx/appcompat/widget/y0;->j(I)Z
    ...
    invoke-virtual {p2, v5, v6}, Landroidx/appcompat/widget/y0;->c(II)I

    move-result v5

    iget-object v7, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {v7, v5}, Lcom/google/android/material/internal/i;->d(I)V

    :cond_b
    sget v5, Le/f/b/b/a$o;->NavigationView_itemIconPadding:I

    invoke-virtual {p2, v5, v6}, Landroidx/appcompat/widget/y0;->c(II)I

    move-result v5

    sget v7, Le/f/b/b/a$o;->NavigationView_itemMaxLines:I

    invoke-virtual {p2, v7, v1}, Landroidx/appcompat/widget/y0;->d(II)I

    move-result v7

    invoke-virtual {p0, v7}, Lcom/google/android/material/navigation/NavigationView;->setItemMaxLines(I)V

    iget-object v7, p0, Lcom/google/android/material/navigation/NavigationView;->f:Lcom/google/android/material/internal/h;
    ...
    invoke-virtual {v7, v1}, Lcom/google/android/material/internal/i;->c(I)V

    iget-object v1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    iget-object v7, p0, Lcom/google/android/material/navigation/NavigationView;->f:Lcom/google/android/material/internal/h;

    invoke-virtual {v1, p1, v7}, Lcom/google/android/material/internal/i;->a(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-virtual {p1, p3}, Lcom/google/android/material/internal/i;->i(I)V

    if-eqz v2, :cond_c

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, v0}, Lcom/google/android/material/internal/i;->h(I)V

    :cond_c
    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, v3}, Lcom/google/android/material/internal/i;->b(Landroid/content/res/ColorStateList;)V

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, v4}, Lcom/google/android/material/internal/i;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, v5}, Lcom/google/android/material/internal/i;->e(I)V

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->f:Lcom/google/android/material/internal/h;

    iget-object p3, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, p3}, Landroidx/appcompat/view/menu/g;->a(Landroidx/appcompat/view/menu/n;)V

    iget-object p1, p0, Lcom/google/android/material/navigation/NavigationView;->g:Lcom/google/android/material/internal/i;

    invoke-virtual {p1, p0}, Lcom/google/android/material/internal/i;->a(Landroid/view/ViewGroup;)Landroidx/appcompat/view/menu/o;
    ...
    sget p1, Le/f/b/b/a$o;->NavigationView_menu:I
    ...
    invoke-virtual {p2, p1, v6}, Landroidx/appcompat/widget/y0;->g(II)I
    ...
    :cond_d
    sget p1, Le/f/b/b/a$o;->NavigationView_headerLayout:I
...
.method private final a(Landroidx/appcompat/widget/y0;)Landroid/graphics/drawable/Drawable;
    .locals 9
    .param p1    # Landroidx/appcompat/widget/y0;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/h0;
    ...
    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeAppearance:I

    const/4 v1, 0x0

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/y0;->g(II)I

    move-result v0

    sget v2, Le/f/b/b/a$o;->NavigationView_itemShapeAppearanceOverlay:I

    invoke-virtual {p1, v2, v1}, Landroidx/appcompat/widget/y0;->g(II)I

    move-result v2

    new-instance v4, Le/f/b/b/r/j;

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getContext()Landroid/content/Context;

    move-result-object v3

    invoke-static {v3, v0, v2}, Le/f/b/b/r/o;->a(Landroid/content/Context;II)Le/f/b/b/r/o$b;
    ...
    invoke-direct {v4, v0}, Le/f/b/b/r/j;-><init>(Le/f/b/b/r/o;)V

    invoke-virtual {p0}, Landroid/widget/FrameLayout;->getContext()Landroid/content/Context;

    move-result-object v0

    sget v2, Le/f/b/b/a$o;->NavigationView_itemShapeFillColor:I

    invoke-static {v0, p1, v2}, Le/f/b/b/o/c;->a(Landroid/content/Context;Landroidx/appcompat/widget/y0;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-virtual {v4, v0}, Le/f/b/b/r/j;->a(Landroid/content/res/ColorStateList;)V

    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeInsetStart:I

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/y0;->c(II)I

    move-result v5

    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeInsetTop:I

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/y0;->c(II)I

    move-result v6

    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeInsetEnd:I

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/y0;->c(II)I

    move-result v7

    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeInsetBottom:I
...
.method private b(Landroidx/appcompat/widget/y0;)Z
    .locals 1
    .param p1    # Landroidx/appcompat/widget/y0;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/y0;->j(I)Z

    move-result v0

    if-nez v0, :cond_1

    sget v0, Le/f/b/b/a$o;->NavigationView_itemShapeAppearanceOverlay:I
...
.method protected a(Lc/i/o/n0;)V
    .locals 1
    .param p1    # Lc/i/o/n0;
        .annotation build Landroidx/annotation/h0;
        .end annotation
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/i;->a(Lc/i/o/n0;)V
...
.method public getCheckedItem()Landroid/view/MenuItem;
    ...
    invoke-virtual {v0}, Lcom/google/android/material/internal/i;->a()Landroidx/appcompat/view/menu/j;
...
.method public setCheckedItem(I)V
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/i;->a(Landroidx/appcompat/view/menu/j;)V
