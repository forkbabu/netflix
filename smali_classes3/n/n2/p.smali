...
.method public constructor <init>()V
    ...
    invoke-direct {p0}, Ln/n2/o;-><init>()V
...
.method private static final a(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/io/PrintWriter;
    .locals 1
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
...
.method public static final a(Ljava/io/File;ILn/p2/s/p;)V
    .locals 1
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
    ...
    sget-object p0, Ln/y1;->a:Ln/y1;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    const/4 p0, 0x0

    invoke-static {v0, p0}, Ln/n2/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method public static final a(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    ...
    invoke-static {p0, p1}, Ln/n2/p;->a(Ljava/io/File;[B)V
...
.method public static synthetic a(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;ILjava/lang/Object;)V
    ...
    sget-object p2, Ln/y2/f;->a:Ljava/nio/charset/Charset;

    :cond_0
    invoke-static {p0, p1, p2}, Ln/n2/p;->a(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V

    return-void
.end method

.method public static final a(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;)V
    .locals 3
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
    ...
    invoke-static {v0, p2}, Ln/n2/x;->a(Ljava/io/Reader;Ln/p2/s/l;)V

    return-void
.end method

.method public static synthetic a(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Ln/n2/p;->a(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;)V

    return-void
.end method

.method public static final a(Ljava/io/File;Ln/p2/s/p;)V
    .locals 1
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
    ...
    invoke-static {p0, v0, p1}, Ln/n2/p;->a(Ljava/io/File;ILn/p2/s/p;)V
...
.method public static final b(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;)Ljava/lang/Object;
    .locals 3
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
    ...
    :try_start_0
    invoke-static {p0}, Ln/n2/x;->a(Ljava/io/BufferedReader;)Ln/w2/m;
...
.method public static synthetic b(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;ILjava/lang/Object;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p0, p3}, Ln/p2/t/i0;->f(Ljava/lang/Object;Ljava/lang/String;)V

    const-string p3, "charset"

    invoke-static {p1, p3}, Ln/p2/t/i0;->f(Ljava/lang/Object;Ljava/lang/String;)V

    const-string p3, "block"

    invoke-static {p2, p3}, Ln/p2/t/i0;->f(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p4}, Ln/p2/t/f0;->b(I)V

    invoke-static {p4, p4, p3}, Ln/m2/l;->a(III)Z
    ...
    :goto_1
    invoke-static {p4}, Ln/p2/t/f0;->a(I)V
...
.method public static final b(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/util/List;
    ...
    new-instance v1, Ln/n2/p$a;

    invoke-direct {v1, v0}, Ln/n2/p$a;-><init>(Ljava/util/ArrayList;)V

    invoke-static {p0, p1, v1}, Ln/n2/p;->a(Ljava/io/File;Ljava/nio/charset/Charset;Ln/p2/s/l;)V
...
.method public static synthetic b(Ljava/io/File;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/util/List;
    ...
    :cond_0
    invoke-static {p0, p1}, Ln/n2/p;->b(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/util/List;
...
.method public static final b(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
    ...
    invoke-static {p0, p1}, Ln/n2/p;->b(Ljava/io/File;[B)V
...
.method public static synthetic b(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;ILjava/lang/Object;)V
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Ln/n2/p;->b(Ljava/io/File;Ljava/lang/String;Ljava/nio/charset/Charset;)V
...
.method public static final c(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {p0}, Ln/n2/x;->b(Ljava/io/Reader;)Ljava/lang/String;
...
.method public static synthetic c(Ljava/io/File;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, p1}, Ln/n2/p;->c(Ljava/io/File;Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method private static final e(Ljava/io/File;)Ljava/io/FileInputStream;
    .locals 1
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
...
.method private static final f(Ljava/io/File;)Ljava/io/FileOutputStream;
    .locals 1
    .param p0    # Ljava/io/File;
        .annotation build Lq/c/a/d;
        .end annotation
...
.method public static final g(Ljava/io/File;)[B
    ...
    invoke-static {v1, v7}, Ln/p2/t/i0;->a(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    new-instance v6, Ln/n2/g;

    const/16 v9, 0x2001

    invoke-direct {v6, v9}, Ln/n2/g;-><init>(I)V

    invoke-virtual {v6, v4}, Ljava/io/ByteArrayOutputStream;->write(I)V

    const/4 v4, 0x2

    invoke-static {v0, v6, v3, v4, v8}, Ln/n2/b;->a(Ljava/io/InputStream;Ljava/io/OutputStream;IILjava/lang/Object;)J
    ...
    invoke-static {p0, v1, v2, v3, v4}, Ln/g2/n;->a([B[BIII)[B
    ...
    :goto_2
    invoke-static {v0, v8}, Ln/n2/c;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
